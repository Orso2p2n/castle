...
Level.prototype = {
	...
	,init: function() {
		...
		var h = Level.loadedTilesCache.h;
		var key_h = h;
		...
		while(c_current < c_length) {
			...
			HxOverrides.remove(this.props.layers,c);
		}
	...
	,setup: function() {
		...
		var callb = this.allocRef(function(_) {
			...
			while(g_current < g_length) {
				var g = g_keys[g_current++];
				var layers = groups_h[g];
				var _g = [];
				var _g1 = 0;
	...
	,onKey: function(e) {
		...
		case 38:
			...
			if(l.current >= l.stride * h) {
				l.set_current(l.current - l.stride * h);
				if(w != 1 || h != 1) {
					l.currentWidth = w;
					l.currentHeight = h;
					l.saveState();
...
Main.prototype = $extend(Model.prototype,{
	initCurFilePath: function() {
		...
		var filePath = haxe_io_Path.normalize("" + haxe_io_Path.addTrailingSlash(process.cwd()) + "/" + arg);
	...
	,searchFilter: function(filter) {
		...
		if(filter != null) {
			...
			while(_g_i < _g_j.length) {
				var t = _g_j[_g_i++];
				if(js_Browser.getLocalStorage().getItem(sheetPath + "#" + Std.string($(t).data("index")) + ":hidden") == "true") {
	...
	,valueHtml: function(c,v,sheet,obj) {
		...
		case 17:
			...
			return out.join("<br/>");
		case 18:
			return "x: " + Std.string(v.x) + ", y: " + Std.string(v.y);
		}
	}
	...
	,editCell: function(column,v,sheet,rowIndex) {
		...
		case 9:
			...
			if(val != null) {
				...
				case 16:
					...
					break;
				case 18:
					inputBox.val(Std.string(val.x) + "," + Std.string(val.y));
					break;
				default:
			...
			inputBox.blur(function(_) {
				...
				if(newValue == "" && column.opt) {
					...
					case 18:
						...
						val2 = { x : parseFloat(split[0]), y : parseFloat(split[1])};
						break;
					default:
						val2 = newValue;
					}
		...
		case 8:case 14:case 17:
			throw haxe_Exception.thrown("assert2");
		case 0:case 1:case 3:case 4:case 16:case 18:
			v.empty();
			...
			if(val != null) {
				...
				case 16:
					...
					break;
				case 18:
					inputBox1.val(Std.string(val.x) + "," + Std.string(val.y));
					break;
				default:
	...
	,refresh: function(text) {
		...
		var _gthis = this;
		console.log("src/Main.hx:1640:","Refresh");
		var nowLoading = window.document.querySelector("#now-loading-text");
	...
	,fillProps: function(content,sheet,props) {
		...
		while(_g < _g1.length) {
			...
			var e = c[0].type;
			var td1 = [td.addClass("t_" + HxOverrides.substr($hxEnums[e.__enum__].__constructs__[e._hx_index]._hx_name,1,null).toLowerCase()).html(this.valueHtml(c[0],v,sheet,props)).appendTo(l[0])];
			var index1 = [index++];
			...
			th.mousedown((function(l,c) {
				return function(e) {
					if(e.which == 3) {
						...
						haxe_Timer.delay((function() {
							return function() {
								_g.popupColumn(sheet1,c1,isProperties);
							};
						})(),1);
						e.preventDefault();
						l[0].click();
	...
	,fillTable: function(content,sheet) {
		...
		var _g = [];
		var _g1 = 0;
		var _this = cdb_ColumnType.__constructs__;
		...
		while(_g < _g1) {
			...
			var e = c[0].type;
			col.addClass("t_" + HxOverrides.substr($hxEnums[e.__enum__].__constructs__[e._hx_index]._hx_name,1,null).toLowerCase());
			...
			while(sheet.sheet.separators[snext] == i) {
				...
				sep.click((function() {
					return function(e) {
						...
						var isCollapsed = js_Browser.getLocalStorage().getItem(sheet.getPath() + "#" + separatorID + ":hidden") != null;
						if(isCollapsed) {
							js_Browser.getLocalStorage().removeItem(sheet.getPath() + "#" + separatorID + ":hidden");
						} else {
							js_Browser.getLocalStorage().setItem(sheet.getPath() + "#" + separatorID + ":hidden","true");
						}
	...
	,setCursor: function(s,x,y,sel,update) {
		...
		console.log("src/Main.hx:2335:","setCursor " + s.sheet.name + " " + x + " " + y + " " + Std.string(sel));
		if(update) {
			this.updateCursor();
		}
	}
	...
	,newColumn: function(sheetName,ref,index) {
		...
		if(ref != null) {
			...
			var e = ref.type;
			tmp.val(HxOverrides.substr($hxEnums[e.__enum__].__constructs__[e._hx_index]._hx_name,1,null).toLowerCase()).change();
	...
	,initMenu: function() {
		...
		mi_collapseAllSeparator.click = function() {
			...
			separators.each(function(i,e) {
				if(js_Browser.getLocalStorage().getItem(sheetPath + "#" + $(e).attr("separatorID") + ":hidden") == null) {
					js_Browser.getLocalStorage().setItem(sheetPath + "#" + $(e).attr("separatorID") + ":hidden","true");
				}
			});
		...
		mi_uncollapseAllSeparator.click = function() {
			...
			separators.each(function(i,e) {
				if(js_Browser.getLocalStorage().getItem(sheetPath + "#" + $(e).attr("separatorID") + ":hidden") != null) {
					js_Browser.getLocalStorage().removeItem(sheetPath + "#" + $(e).attr("separatorID") + ":hidden");
				}
			});
			rows.each(function(i,e) {
				if($(e).hasClass("collapsed")) {
...
cdb_Database.prototype = {
	...
	,valToString: function(t,val,esc) {
		...
		case 18:
			return "x: " + Std.string(val.x) + ", y: " + Std.string(val.y);
		}
	}
...
var cdb_LocField = $hxEnums["cdb.LocField"] = { __ename__:"cdb.LocField",__constructs__:null
	,LName: ($_=function(c) { return {_hx_index:0,c:c,__enum__:"cdb.LocField",toString:$estr}; },$_._hx_name="LName",$_.__params__ = ["c"],$_)
	,LSub: ($_=function(c,s,e) { return {_hx_index:1,c:c,s:s,e:e,__enum__:"cdb.LocField",toString:$estr}; },$_._hx_name="LSub",$_.__params__ = ["c","s","e"],$_)
	,LSingle: ($_=function(c,e) { return {_hx_index:2,c:c,e:e,__enum__:"cdb.LocField",toString:$estr}; },$_._hx_name="LSingle",$_.__params__ = ["c","e"],$_)
};
	...
	,applyRec: function(path,f,o,data,out) {
		...
		case 0:
			...
			if(v != null) {
				...
				var str = StringTools.htmlUnescape(haxe_xml_Access.get_innerHTML(x));
				var ref;
				if(v.ref == null) {
					ref = null;
				} else {
					...
					ref = StringTools.htmlUnescape(haxe_xml_Access.get_innerHTML(x));
				}
...
cdb_MultifileLoadSave.nukeZombieFiles = function(data,schemaPath) {
	...
	var h = cdb_MultifileLoadSave.lastStateOnDisk.h;
	var oldFile_h = h;
	var oldFile_keys = Object.keys(h);
	var oldFile_length = oldFile_keys.length;
	var oldFile_current = 0;
	while(oldFile_current < oldFile_length) {
		var oldFile = oldFile_keys[oldFile_current++];
		if(cdb_MultifileLoadSave.lastStateOnDisk.h[oldFile] == null || Object.prototype.hasOwnProperty.call(cdb_MultifileLoadSave.saveStateOnDisk.h,oldFile)) {
			continue;
		}
		js_node_Fs.unlinkSync(oldFile);
		var parentDir = haxe_io_Path.directory(oldFile);
...
cdb_Parser.saveType = function(t,legacyIntNames) {
	...
	case 12:
		var _g = t.type;
		return baseName + ":" + Std.string(Type.enumParameters(t)[0]);
	case 0:case 1:case 2:case 3:case 4:case 7:case 8:case 11:case 13:case 14:case 15:case 16:case 17:case 18:
		return baseName;
	}
};
...
var lvl_LayerInnerData = $hxEnums["lvl.LayerInnerData"] = { __ename__:"lvl.LayerInnerData",__constructs__:null
	,Layer: ($_=function(a) { return {_hx_index:0,a:a,__enum__:"lvl.LayerInnerData",toString:$estr}; },$_._hx_name="Layer",$_.__params__ = ["a"],$_)
	,Objects: ($_=function(idCol,objs) { return {_hx_index:1,idCol:idCol,objs:objs,__enum__:"lvl.LayerInnerData",toString:$estr}; },$_._hx_name="Objects",$_.__params__ = ["idCol","objs"],$_)
	,Tiles: ($_=function(t,data) { return {_hx_index:2,t:t,data:data,__enum__:"lvl.LayerInnerData",toString:$estr}; },$_._hx_name="Tiles",$_.__params__ = ["t","data"],$_)
	,TileInstances: ($_=function(t,insts) { return {_hx_index:3,t:t,insts:insts,__enum__:"lvl.LayerInnerData",toString:$estr}; },$_._hx_name="TileInstances",$_.__params__ = ["t","insts"],$_)
};
lvl_LayerInnerData.__constructs__ = [lvl_LayerInnerData.Layer,lvl_LayerInnerData.Objects,lvl_LayerInnerData.Tiles,lvl_LayerInnerData.TileInstances];
...
var vdom_Answer = $hxEnums["vdom.Answer"] = { __ename__:"vdom.Answer",__constructs__:null
	,Event: ($_=function(eid,props) { return {_hx_index:0,eid:eid,props:props,__enum__:"vdom.Answer",toString:$estr}; },$_._hx_name="Event",$_.__params__ = ["eid","props"],$_)
	,SetValue: ($_=function(id,value) { return {_hx_index:1,id:id,value:value,__enum__:"vdom.Answer",toString:$estr}; },$_._hx_name="SetValue",$_.__params__ = ["id","value"],$_)
	,Done: ($_=function(eid) { return {_hx_index:2,eid:eid,__enum__:"vdom.Answer",toString:$estr}; },$_._hx_name="Done",$_.__params__ = ["eid"],$_)
};
vdom_Answer.__constructs__ = [vdom_Answer.Event,vdom_Answer.SetValue,vdom_Answer.Done];
var vdom_Message = $hxEnums["vdom.Message"] = { __ename__:"vdom.Message",__constructs__:null
	,Create: ($_=function(id,name,attr) { return {_hx_index:0,id:id,name:name,attr:attr,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Create",$_.__params__ = ["id","name","attr"],$_)
	,AddClass: ($_=function(id,name) { return {_hx_index:1,id:id,name:name,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="AddClass",$_.__params__ = ["id","name"],$_)
	,RemoveClass: ($_=function(id,name) { return {_hx_index:2,id:id,name:name,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="RemoveClass",$_.__params__ = ["id","name"],$_)
	,Append: ($_=function(id,to) { return {_hx_index:3,id:id,to:to,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Append",$_.__params__ = ["id","to"],$_)
	,InsertAt: ($_=function(id,to,pos) { return {_hx_index:4,id:id,to:to,pos:pos,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="InsertAt",$_.__params__ = ["id","to","pos"],$_)
	,CreateText: ($_=function(id,text,pid) { return {_hx_index:5,id:id,text:text,pid:pid,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="CreateText",$_.__params__ = ["id","text","pid"],$_)
	,Reset: ($_=function(id) { return {_hx_index:6,id:id,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Reset",$_.__params__ = ["id"],$_)
	,Remove: ($_=function(id) { return {_hx_index:7,id:id,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Remove",$_.__params__ = ["id"],$_)
	,Event: ($_=function(id,name,eid) { return {_hx_index:8,id:id,name:name,eid:eid,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Event",$_.__params__ = ["id","name","eid"],$_)
	,SetAttr: ($_=function(id,att,val) { return {_hx_index:9,id:id,att:att,val:val,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="SetAttr",$_.__params__ = ["id","att","val"],$_)
	,SetStyle: ($_=function(id,st,val) { return {_hx_index:10,id:id,st:st,val:val,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="SetStyle",$_.__params__ = ["id","st","val"],$_)
	,Trigger: ($_=function(id,name) { return {_hx_index:11,id:id,name:name,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Trigger",$_.__params__ = ["id","name"],$_)
	,Special: ($_=function(id,name,args,eid) { return {_hx_index:12,id:id,name:name,args:args,eid:eid,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Special",$_.__params__ = ["id","name","args","eid"],$_)
	,Anim: ($_=function(id,name,dur) { return {_hx_index:13,id:id,name:name,dur:dur,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Anim",$_.__params__ = ["id","name","dur"],$_)
	,Dispose: ($_=function(id,events) { return {_hx_index:14,id:id,events:events,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Dispose",$_.__params__ = ["id","events"],$_)
	,Unbind: ($_=function(events) { return {_hx_index:15,events:events,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Unbind",$_.__params__ = ["events"],$_)
	,Group: ($_=function(msg) { return {_hx_index:16,msg:msg,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="Group",$_.__params__ = ["msg"],$_)
	,SetVal: ($_=function(id,value) { return {_hx_index:17,id:id,value:value,__enum__:"vdom.Message",toString:$estr}; },$_._hx_name="SetVal",$_.__params__ = ["id","value"],$_)
};
vdom_Message.__constructs__ = [vdom_Message.Create,vdom_Message.AddClass,vdom_Message.RemoveClass,vdom_Message.Append,vdom_Message.InsertAt,vdom_Message.CreateText,vdom_Message.Reset,vdom_Message.Remove,vdom_Message.Event,vdom_Message.SetAttr,vdom_Message.SetStyle,vdom_Message.Trigger,vdom_Message.Special,vdom_Message.Anim,vdom_Message.Dispose,vdom_Message.Unbind,vdom_Message.Group,vdom_Message.SetVal];
